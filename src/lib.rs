// src/lib.rs
/*
 * Core library for MetamaskVault
 */
...
#[derive(Debug)]
pub struct MetamaskVaultProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MetamaskVaultProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MetamaskVault processing");
    
    let mut processor = MetamaskVaultProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MetamaskVaultProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MetamaskVaultProcessor::new(false);
